...
namespace Noseratio.ThreadAffinity
{
    ...
    static class PumpingTest
    {
        ...
        {
            using (var staThread = new Noseratio.ThreadAffinity.ThreadWithAffinityContext(true, true))
            {
            ...
            Console.WriteLine("staThread.Run, thread: " + Thread.CurrentThread.ManagedThreadId);
        }
